...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      <main className="flex-1 container mx-auto px-4 sm:px-6 lg:px-10 py-12">
        <h2
          className={`pt-2 text-2xl sm:text-3xl md:text-4xl font-bold mb-8 text-center md:text-left ${
            darkMode ? "text-white" : "text-gray-700"
          }`}
        >
          New Articles
